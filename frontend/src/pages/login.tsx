...
export default function Login() {
  ...
  const title = 'Stock Adjustment Website';
                ...
                <div>
                  <p className='mb-2'>
                    ...
                    <code
                      ...
                      data-password='8f15ea4e'
                      onClick={(e) => setLogin(e.target)}
                    >
                      super_admin@flatlogic.com
                    </code>
                    {' / '}
                    <code className={`${textColor}`}>8f15ea4e</code>
                    {' / '}
                  ...
                  <p>
                    ...
                    <code
                      className={`cursor-pointer ${textColor} `}
                      data-password='3b3455211e64'
                      onClick={(e) => setLogin(e.target)}
                    >
                      client@hello.com
                    </code>
                    {' / '}
                    <code className={`${textColor}`}>3b3455211e64</code>
                    {' / '}
                    to login as User
                  </p>
                </div>
