module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('sales', 'organizationsId', {
        transaction,
      });

      await queryInterface.removeColumn('products', 'organizationsId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('sales', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('sales', 'sale_date', { transaction });

      await queryInterface.removeColumn('sales', 'quantity_sold', {
        transaction,
      });

      await queryInterface.removeColumn('sales', 'productId', { transaction });
