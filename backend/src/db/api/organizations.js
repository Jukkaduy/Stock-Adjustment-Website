...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.products_organization = await organizations.getProducts_organization(
      {
        transaction,
      },
    );

    output.products_organizations =
      await organizations.getProducts_organizations({
        transaction,
      });

    output.sales_organization = await organizations.getSales_organization({
      transaction,
    });

    output.sales_organizations = await organizations.getSales_organizations({
      transaction,
    });
