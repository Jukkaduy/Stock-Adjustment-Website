...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('roles', [
      ...
      {
        id: getId('stock_observer'),
        name: 'stock_observer',
        createdAt,
        updatedAt,
      },

      { id: getId('guest_viewer'), name: 'guest_viewer', createdAt, updatedAt },
...
primary key ("roles_permissionsId", "permissionId")
    ...
    await queryInterface.bulkInsert('rolesPermissionsPermissions', [
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('inventory_lead'),
        permissionId: getId('CREATE_USERS'),
      },
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('sales_analyst'),
        permissionId: getId('CREATE_USERS'),
      },
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('stock_observer'),
        permissionId: getId('CREATE_USERS'),
      },
...

      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('guest_viewer'),
        permissionId: getId('READ_USERS'),
      },
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('system_manager'),
        permissionId: getId('CREATE_SALES'),
      },
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('system_manager'),
        permissionId: getId('UPDATE_SALES'),
      },

      {
        ...
        updatedAt,
        roles_permissionsId: getId('system_manager'),
        permissionId: getId('DELETE_SALES'),
      },
